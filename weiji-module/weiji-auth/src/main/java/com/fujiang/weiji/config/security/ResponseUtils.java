package com.fujiang.weiji.config.security;
...
public class ResponseUtils {
     ...
     * @param result
     */
    public static void out(ServletResponse response, DataResponse result) {
    ...
    public static void getResponse(HttpServletResponse httpServletResponse, String msg, Integer status) {
        ...
        try {
            ...
            writer.print(JSONObject.toJSONString(new DataResponse(status, msg, null)));
        } catch (IOException e) {
